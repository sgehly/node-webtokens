...
exports.generate = function(alg, enc, payload, key, options, cb) {
  // alg, enc, payload, key[, cb] or alg, enc, payload, keystore[0], kid[1], salt[2][, cb[3]]
  ...
  if (aMatch[2]) {
    ...
    if(typeof options.buffer == Buffer){
      salt = options.buffer;
    }else{
